...
$\disp\sum_{n=1}^\infty\dfrac{\cos(n\pi)}{n^2}$
...
\boxenv{Definition.}{An \textbf{alternating series} is an infinite sum of the form
...
\boxenv{Alternating Series Test.}{Given an alternating series defined as above, if both of the following are true\dots
