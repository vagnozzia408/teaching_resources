...
\begin{flushright}
	...
	\addplot [domain=0:2*pi,samples=1000,color=blue,thick]({(sin(deg(x)))^3},{(cos(deg(x)))^3});
    \end{axis}
    \end{tikzpicture}
\end{flushright}
...
%       	ytick={-1,0,1},
	...
	\addplot [domain=0:2*pi,samples=1000,color=blue,thick]({2+sqrt(x)},2-4*x);
    \end{axis}
    \end{tikzpicture}
\end{flushright}
...
\begin{flushright}
	...
	\addplot [domain=0:2*pi,samples=1000,color=blue,thick]({1*(cos(deg(x)))},{2*(sin(deg(x)))});
    \end{axis}
    \end{tikzpicture}
\end{flushright}
